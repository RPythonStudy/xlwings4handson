# 프로젝트 목적
 > Windows(native)와 macOS 운영체제에서 Microsoft사의 Excel 형식으로 저장된 파일에서 Excel의 각 셀에  고유의 서식/수식/메모가 지정되어 있더라도 이를 보존하면서도 파이썬으로 cell 값들을 조작하는 방법을 실습용으로 구현한 프로젝트입니다.
 > 보다 자세한 내용은 [프로젝트 개요](wiki/Project-Overview.md) 참조 바랍니다.   
